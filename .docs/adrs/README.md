...
| [0009](./0009-reposition-as-engineering-memory-system-with-ab-test.md) | Reposition as engineering-memory system; validate via gtag-based A/B/C hero test | Superseded by ADR-0010 | 2026-06-30 |
| [0010](./0010-reposition-as-engineering-operating-model.md) | Reposition as engineering operating model for human–AI software development; supersede ADR-0009 | Accepted | 2026-06-30 |
